...
''' this blok need to provide an icon to the tools bar'''
try:
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        '''
        # MainWindow.setWindowIcon(QtGui.QIcon('pointing.ico'))
...
if __name__ == "__main__":
    ...
    scriptDir = os.path.dirname(os.path.realpath(__file__))
    app.setWindowIcon(QtGui.QIcon(scriptDir + os.path.sep + 'MaShalled.ico'))
